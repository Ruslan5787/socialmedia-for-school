...
export const EventPage = () => {
    ...
    const [chartData, setChartData] = useState([{name: "Просмотрели", value: 0}, {
        name: "Не просмотрели", value: 0
    }]);
        ...
        const fetchChartData = async () => {
            try {
                ...
                if (role === "teacher" && event) {
                    ...
                    setChartData([{name: "Просмотрели", value: viewedUsers}, {
    ...
    return (<Box>
        {loading ? (<Flex justify="center" align="center" minH="100vh">
            <Spinner/>
        </Flex>) : event ? (<Flex direction="column" gap={4} maxW="800px" mx="auto">
            ...
            {event.address && (<Box id="map" width="100%" height="400px" mt={4}/>)}

            {/* Круговая диаграмма для учителей */}
            {role === "teacher" && chartData !== null && (<Box mt={6}>
        ...
        </Flex>) : (<Text>Мероприятие не найдено</Text>)}
    </Box>);
};